...
<form id="userDelete" action="deletePromo" enctype="text/plain" method="post">
    <p>Номер машины:&nbsp;<input maxlength="8" name="num" type="text" required-pattern="^[a-zA-Z0-9]+$">${info}</p>
    <p>&nbsp; <input type="submit" value="Удалить объявление"></p>
</form>
<form id="userLogOut" action="logOut" enctype="text/plain" method="get">
